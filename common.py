...
class Transform:
    def __init__(self):
        ...
        # train_transform resize: 256 for mobilenet, 330 for inception, 320 for resnet50
        # train_transform/val_transform: 224 for mobilenet, 299 for inception, 300 for resnet50
        ...
        self._val_transform = transforms.Compose([transforms.Resize((300, 300)), transforms.ToTensor(), normalize])
